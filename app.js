...
let state=JSON.parse(localStorage.getItem(KEY)||"null")||{target:1850,waterTarget:2000,weight:null,weights:[],customFoods:[],days:{}};
...
document.getElementById("addFoodBtn").onclick=openFood;document.getElementById("addWaterBtn").onclick=openWater;document.getElementById("subtractWater").onclick=subtractWater;document.getElementById("weightBtn").onclick=openWeight;document.getElementById("settingsBtn").onclick=openSettings;document.getElementById("historyBtn").onclick=openHistory;document.getElementById("foodsBtn").onclick=openMyFoods;document.getElementById("closeModal").onclick=closeModal;document.getElementById("modalBackdrop").addEventListener("click",e=>{if(e.target.id==="modalBackdrop")closeModal()});
render();
